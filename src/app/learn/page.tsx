    ...
    <main className="min-h-screen p-8">
      <div className="container mx-auto px-4 py-8 max-w-3xl">
        ...
        <section className="mb-8 space-y-4">
          ...
          <div className="bg-neutral-800/50 rounded-lg p-4 border-l-4 border-purple-500">
        ...
        <section className="mb-8 space-y-4">
          ...
          <div className="space-y-6">
            <div className="bg-neutral-800/30 rounded-lg p-5 border border-neutral-700">
              ...
              <p className="text-neutral-400">
                <strong className="text-neutral-300">Example:</strong> A 2-mana 2/2 creature
            ...
            <div className="bg-neutral-800/30 rounded-lg p-5 border border-neutral-700">
              ...
              <p className="text-neutral-400">
                <strong className="text-neutral-300">Example:</strong> Artifact or enchantment
            ...
            <div className="bg-neutral-800/30 rounded-lg p-5 border border-neutral-700">
              ...
              <p className="text-neutral-400">
                <strong className="text-neutral-300">Example:</strong> If Blue-White fliers is
            ...
            <div className="bg-neutral-800/30 rounded-lg p-5 border border-neutral-700">
              ...
              <p className="text-neutral-400">
                <strong className="text-neutral-300">Considerations:</strong>
              </p>
        ...
        <section className="mb-8 space-y-4">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div className="bg-neutral-800/30 rounded-lg p-4 border border-neutral-700">
              <h3 className="text-lg font-semibold text-purple-400 mb-2">IWD</h3>
